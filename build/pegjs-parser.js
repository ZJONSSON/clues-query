...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c13 = function(path) { return { not: path }; },
      peg$c14 = "and(",
      peg$c15 = peg$literalExpectation("and(", false),
      peg$c16 = function(path) { return { and: path }; },
      peg$c17 = "or(",
      peg$c18 = peg$literalExpectation("or(", false),
      peg$c19 = function(path) { return { or: path }; },
      peg$c20 = "\u1409",
      peg$c21 = peg$literalExpectation("\u1409", false),
      ...
      peg$c27 = function(remoteLink) {
        return { remoteLink }
      },
      peg$c28 = function(left, operation, right) {
        return {
          equation: { left, right },
          operation
        }
      ...
      peg$c45 = /^[^.\u1409\u1405()<>!|\u039B=${}]/,
      peg$c46 = peg$classExpectation([".", "\u1409", "\u1405", "(", ")", "<", ">", "!", "|", "\u039B", "=", "$", "{", "}"], true, false),
      peg$c47 = /^[=]/,
      ...
      peg$c50 = /^[^.\u1409\u1405()|\u039B=${}<>!]/,
      peg$c51 = peg$classExpectation([".", "\u1409", "\u1405", "(", ")", "|", "\u039B", "=", "$", "{", "}", "<", ">", "!"], true, false),
      peg$c52 = ".",
      peg$c53 = peg$literalExpectation(".", false),
      peg$c54 = "\u1405",
      peg$c55 = peg$literalExpectation("\u1405", false),
  ...
  function peg$parseRightSideOfEquation() {
    var s0, s1, s2, s3;
  ...
  function peg$parseEquation() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$parseRightSideOfEquation();
        if (s3 !== peg$FAILED) {
          peg$savedPos = s0;
          s1 = peg$c28(s1, s2, s3);
          s0 = s1;
  ...
  function peg$parseBase64FriendlyWord() {
    var s0, s1, s2, s3;
