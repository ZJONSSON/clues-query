...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c43 = "date",
      peg$c44 = peg$literalExpectation("date", false),
      ...
      peg$c52 = function(operation, path, amount) {
        return {
          date: operation,
          path,
          amount
  ...
  function peg$parseToDate() {
    var s0, s1, s2, s3;

    s0 = peg$parseLiteralDate();
    if (s0 === peg$FAILED) {
      s0 = peg$currPos;
      if (input.substr(peg$currPos, 4) === peg$c43) {
        s1 = peg$c43;
